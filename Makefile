...
build_init: init
	bash -c "if [[ ! -f ./docker-compose.yml ]]; then wget https://raw.githubusercontent.com/neelmehta247/docker-cs350-os161/master/docker-compose.yml -O docker-compose.yml; fi"
	bash -c "if [[ ! -f ./Dockerfile ]]; then wget https://raw.githubusercontent.com/neelmehta247/docker-cs350-os161/master//Dockerfile -O Dockerfile; fi"
